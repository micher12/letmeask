...
import type { GetQuestionsRequest } from '@/http/interfaces/get-questions-request'


export function QuestionItem({question}: {question: GetQuestionsRequest}) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-end">
                        <span className="text-muted-foreground text-xs">
                            {dayAgo(question.createdAt).toNow()}
                        </span>
                    </div>
                </div>
            </CardContent>
