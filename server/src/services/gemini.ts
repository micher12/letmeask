...
export async function genereteAnswer(question: string, transcriptions: string[]){
    ...
    const prompt = `
        ...
        - Cite trechos relevantes do contexto de apropriado;
        - Se for citar o contexto, utilize o termo "Contéudo encontrado";
    `.trim();
